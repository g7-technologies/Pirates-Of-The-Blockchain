    ...
    <Wrapper>
      ...
      <Container>
        ...
        <div className="buttonBottomText">
          ...
          <div className="text">
            <p>
              Pirates of the Blockchain is a unique set of 10,000 pirates
              created from the DNA of capt Darren Soto. <br /> POTB was created for everyone in the crypto space,
              no matter your race, gender, or financial status. The Pirates of
              the block chain welcome you to join a social, virtually, and
              financial experiment. Our goal is to show a new way of investing
              in not only a NFT, but a NFT project and community. We strive to
              create a space that is fun, engaging, and community driven. We are
              the Pirates of the blockchain and welcome you.
            </p>
          </div>
        </div>
      </Container>
...
export default CarouselBannerMbl;
